...
router.post("/init", validate(checkoutInitSchema), async (req: AuthenticatedRequest, res: Response) => {
...
router.post("/verify", validate(checkoutVerifySchema), async (req: AuthenticatedRequest, res: Response) => {
