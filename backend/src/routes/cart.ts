...
router.post("/items", validate(cartItemSchema), async (req: AuthenticatedRequest, res: Response) => {
...
router.put("/items/:id", validate(cartItemUpdateSchema), async (req: AuthenticatedRequest, res: Response) => {
