      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {["Dresses", "Outerwear", "Accessories"].map((category, i) => (
            <a href="/shop" key={category} className="group relative aspect-[4/5] overflow-hidden rounded-[16px] bg-muted block">
              <img
                src={[
      ...
      <section className="py-24 bg-accent/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex items-end justify-between mb-12">
            ...
            <a href="/shop" className="hidden md:flex items-center text-sm font-medium hover:text-accent transition-colors">
          ...
          <a href="/shop" className="mt-8 flex md:hidden items-center justify-center text-sm font-medium">
            View All <ArrowRight className="w-4 h-4 ml-2" />
          </a>
        </div>
      </section>
